...
const ProductsDashboard = () => {
    ...
    const fetchData = () => {
        ...
        axios.get("https://6405e668eed195a99f901a0d.mockapi.io/products").then(res => {
    ...
    const onSubmit = (id,data) => {
        setFormLoading(true);
        if(id){
            axios.put(`https://6405e668eed195a99f901a0d.mockapi.io/products/${id}`,data).then(res=>{
                fetchData();
                setFormData(DEFAULT_USER);
            })
        }
        else{
            axios.post("https://6405e668eed195a99f901a0d.mockapi.io/products",data).then(res=>{
                fetchData();
            })
        }
        setOpen(false);
    ...
    const onDelete = (id) => {
        axios.delete(`https://6405e668eed195a99f901a0d.mockapi.io/products/${id}`).then(res => {
            fetchData();
        })
    }
    ...
    const onEdit = (id) => {
        setOpen(true);
        axios.get(`https://6405e668eed195a99f901a0d.mockapi.io/products/${id}`).then(res=>{
